...
const BusinessMessages: React.FC = () => {
  ...
  // Filter conversations relevant to this business
  const businessConversations = sortedConversations.filter(
    conversation => conversation.businessId === business.id
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <h2 className="text-lg font-bold mb-6">Customer Inquiries</h2>
              ...
              <div className="text-center py-10 text-gray-500">
                {searchTerm ? (
                  ...
                  <div>
                    ...
                    <p className="text-lg mb-2">No customer messages yet</p>
                    <p className="text-sm">When customers inquire about your business, messages will appear here</p>
                  </div>
                )}
              </div>
            ) : (
